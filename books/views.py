...
class AuthorStatPagination(PageNumberPagination):
    page_size = 10  # Число книг на странице
...
class AuthorViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=['get'], pagination_class=AuthorStatPagination)
    def stats(self, request):
        authors = Author.objects.prefetch_related('books').annotate(book_count=models.Count('books'))
